...
The configuration window offers Modest, Standard, and Generous contracts. These settings control bounty payments and the combat bonus received by neutral bounty creatures. Bounty troops led by a player hero still count as valid targets, but receive no combat bonus. The maximum payout is 30,000, 40,000, or 50,000 Gold per game month respectively.
